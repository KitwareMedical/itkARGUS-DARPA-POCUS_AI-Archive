...
class ARGUS_LinearAR:
    def __init__(self, device_name='cpu', model_dir='Models'):
        ...
        arnet_model_filename = path.join(model_dir, "BAMC_PTX_ARUNET-3D-PR-Final15", "Epoch333_model.pth")
        roinet_model_filename = path.join(model_dir, "BAMC_PTX_ROINet-StdDevExtended-ExtrudedNS-Final15", "Epoch333_model.pth")
