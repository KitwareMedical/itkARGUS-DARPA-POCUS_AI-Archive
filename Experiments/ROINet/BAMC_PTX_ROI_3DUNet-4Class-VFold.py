...
all_images = sorted(glob(os.path.join(img1_dir, '*.roi.mha')))
all_labels = sorted(glob(os.path.join(img1_dir, '*.roi.overlay.mha')))
...
roi_size = (num_slices, arr.shape[1], arr.shape[2])
