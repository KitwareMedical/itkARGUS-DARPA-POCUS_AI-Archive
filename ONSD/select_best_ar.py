...
from ARGUS_onsd_ar_train import ARGUS_onsd_ar_train

nnet = ARGUS_onsd_ar_train("../ARGUS/ARGUS_onsd_ar.cfg", "vfold", device_num=0)
nnet.image_dirname = ["Data_ONSD/images"]
nnet.label_dirname = ["Data_ONSD/labels"]
...
for r in range(nnet.num_models):
    print("*** Run", r)
    nnet.setup_testing_vfold(vfold_num=0, run_num=0)
