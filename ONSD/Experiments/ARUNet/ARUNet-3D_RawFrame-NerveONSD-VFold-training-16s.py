...
def main():
    parser = argparse.ArgumentParser(description="ONSD Experiment", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    ...
    experiment_type = '3D' #'Mean_StdOverTime_RawFrame'

    model_filename_base = "./results/BAMC_ONSD_ARUNet-" + str(experiment_type) + "-yuriNerveData-" + str(num_slice) + "s-VFold-Run" + str(run_id)
