...
def main():
    ...
    model_filename_base = "./results/BAMC_ONSD_ARViTUNet-Mean_StdDevOverTime_RawFrame_Gradient-224x224-" + str(num_slice) + "s-VFold-Run" + str(run_id)
