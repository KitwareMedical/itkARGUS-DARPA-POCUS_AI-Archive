...
def main():
    ...
    img1_dir = "../../Data_ONSD/Preprocessed/Resized/"
    img2_dir = "../../Data_ONSD/Annotations/CLEANED/Resized/"
    ...
    model_filename_base = "./results/BAMC_ONSD_ARSwinUNet-Mean_StdDevOverTime_RawFrame_Gradient-320x480-" + str(num_slice) + "s-VFold-Run" + str(run_id)
