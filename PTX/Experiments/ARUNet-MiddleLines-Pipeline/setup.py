...
NAME = 'pocusnet'
VERSION = parse_version('pocusnet/__init__.py')
...
if __name__ == '__main__':
    setup(
        ...
        description=('The Pocus Trainer Module'),
        url='https://github.com/KitwareMedical/AnatomicRecon-POCUS-AI/',
        ...
        #         'pocusnet = pocusnet.__main__:main'
        #     ]
        # },
        classifiers=[
