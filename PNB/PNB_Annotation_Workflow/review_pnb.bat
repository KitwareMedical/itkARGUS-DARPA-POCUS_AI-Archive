...
for %%f in (.\images_to_be_reviewed\*) do (
	...
	.\ImageViewer.windows-2019\ImageViewer.exe -s 0 --fixedSliceDelta 1 --preserveOverlayPaint -W p2,Artery,20,1,p2,Needle,7,2 -b 0.5 -S ".\annotations\%%~nf" -j ".\annotations_to_be_reviewed\%%~nf.overlay.mha" "%%f"
